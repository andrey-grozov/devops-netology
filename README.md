...
## [Домашнее задание к занятию "10.01. Зачем и что нужно мониторить"](10-monitoring-01-base/README.md)

## [Домашнее задание к занятию "7.3. Основы и принцип работы Терраформ"](07-terraform-03-basic/readme.md)
...
## [Домашнее задание к занятию "6.3. MySQL"](/06-db-03-mysql/readme.md)

## [Домашнее задание к занятию "6.2. SQL"](/06-db-02-sql/readme.md)

## [Домашнее задание к занятию "6.1. Типы и структура СУБД"](/06-db-01-basic/readme.md)

## [Домашнее задание к занятию "5.4. Практические навыки работы с Docker"](/05-virt-04-docker-practical-skills/readme.md)

## [Домашнее задание к занятию "5.3. Контейнеризация на примере Docker"](/05-virt-03-docker-usage/readme.md)

## [Домашнее задание к занятию "5.2. Системы управления виртуализацией"](/05-virt-02-control-systems/readme.md)

## [Домашнее задание к занятию "5.1. Основы виртуализации"](/05-virt-01-basics/readme.md)
